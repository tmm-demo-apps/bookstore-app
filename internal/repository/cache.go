...
func (c *CachedProductRepository) ListProductsPaginated(page, pageSize int) (*models.ProductsResult, error) {
	// For paginated requests, we don't cache (too many variations)
